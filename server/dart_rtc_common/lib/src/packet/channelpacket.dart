...
class ChannelPacket extends Packet {
  ChannelPacket(this.id, this.channelId, this.owner, this.users, this.limit);
  ChannelPacket.With(
      this.id, this.channelId, this.owner, this.users, this.limit);
  ...
  static ChannelPacket fromMap(Map m) {
    return new ChannelPacket.With(
        m['id'], m['channelId'], m['owner'], m['users'], m['limit']);
  }
}
...
class RemoveUserCommand extends Command {
  RemoveUserCommand(this.id, this.channelId);
  ...
  Map toJson() {
    return {'id': id, 'channelId': channelId, 'packetType': packetType};
  }
...
class ChannelJoinCommand extends Command {
  ChannelJoinCommand(this.id, this.channelId);
...
class ChangeNickCommand extends Command {
  ChangeNickCommand(this.id, this.newId);
  ...
  Map toJson() {
    return {'id': id, 'newId': newId, 'packetType': packetType.toString()};
  }
...
class SetChannelVarsCommand extends Command {
  SetChannelVarsCommand(this.id, this.channelId, this.limit);
